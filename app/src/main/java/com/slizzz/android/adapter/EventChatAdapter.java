...
public class EventChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public EventChatAdapter(Context context, View.OnClickListener clickListner, List<Event> eventList)
    {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if  (holder instanceof MyEventHolder) {
            ...
            itemHolder.utilLayout.setVisibility(View.GONE);
    ...
    public class MyEventHolder extends RecyclerView.ViewHolder {
        ...
        private LinearLayout utilLayout;
        ...
        public MyEventHolder(View itemView, View.OnClickListener listner) {
            ...
            utilLayout = (LinearLayout) itemView.findViewById(R.id.utilLayout);
