...
public class MyAttendingEventListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyAttendingEventListAdapter(Context context, View.OnClickListener clickListner, List<Event> eventList)
    {
    ...
    public class MyEventHolder extends RecyclerView.ViewHolder {
        ...
        private FancyButton attendeCount, addSharedHost;
